...
final class EditingTrackerViewController: UIViewController {
    var viewModel: EditingTrackerViewModel
    ...
    init(viewModel: EditingTrackerViewModel) {
...
extension EditingTrackerViewController: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        case Sections.emoji.rawValue:
            return ColorsEmojies.allEmojies.count
        case Sections.color.rawValue:
            return ColorsEmojies.allColors.count
        default:
            return .zero
        }
    }
    ...
    private func configureEmojiCell(cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setEmoji(with: ColorsEmojies.allEmojies[indexPath.row])
    ...
    private func configureColorCell(cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.prepareForReuse()
        cell.setColor(with: ColorsEmojies.allColors[indexPath.row])
        if  UIColorMarshalling.isEqual(color1: ColorsEmojies.allColors[indexPath.row], to: viewModel.trackerInfo.color!) {
...
extension EditingTrackerViewController: ShowScheduleDelegate {
...
extension EditingTrackerViewController: ShowCategoriesDelegate {
