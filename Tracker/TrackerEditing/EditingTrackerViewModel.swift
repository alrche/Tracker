...
final class EditingTrackerViewModel {
...
extension EditingTrackerViewModel: ScheduleProtocol {
...
extension EditingTrackerViewModel: CategoryWasSelectedProtocol {
...
extension EditingTrackerViewModel: SaveNameTrackerDelegate {
