...
final class TrackerCollectionViewCell: UICollectionViewCell {
    ...
    func buttonClicked() {
        ...
        if !checkIfTrackerWasCompleted() {
            ...
            addButton.setImage(UIImage(named: "tracker_add"), for: .normal)
            addButton.tintColor = .trackerWhite
    ...
    private func setupCircle() {
        circle.backgroundColor = UIColor.trackerWhite.withAlphaComponent(0.3)
    ...
    private func setupTitle() {
        titleLabel.textColor = .trackerWhite
