...
final class TrackerPresenter {
    ...
    func deleteTracker(tracker: Tracker) {
        reportToAppMetricaService(event: .click, params: ["screen" : "Main", "item" : "delete"])
        do {
    ...
    func editTracker(tracker: TrackerInfoCell, category: TrackerCategory) {
        reportToAppMetricaService(event: .click, params: ["screen" : "Main", "item" : "edit"])
        let viewModel = EditingTrackerViewModel(trackerInfo: TrackerInfoModel(
            id: tracker.id,
            name: tracker.name,
            color: tracker.color,
            emoji: tracker.emoji,
    ...
    func filterButtonPressed() {
        reportToAppMetricaService(event: .click, params: ["screen" : "Main", "item" : "filter"])
