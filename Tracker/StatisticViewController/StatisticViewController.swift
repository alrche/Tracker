...
final class StatisticViewController: UIViewController, ViewConfigurable {
    ...
    private let customNavigationBar: UIView = {
        ...
        navigationBar.backgroundColor = .trackerBackground
    ...
    private let statisticCollectionView: UICollectionView = {
        ...
        layout.itemSize = CGSize(width: UIScreen.main.bounds.width - 32, height: 90)

        let collectionView = UICollectionView(frame: .zero, collectionViewLayout: layout)
        collectionView.backgroundColor = .trackerBackground
